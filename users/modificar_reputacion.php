  ...
  <div class="row">
    <div class="col-xs-12">
      ...
      <form action= "reputacion_mod_exitosa.php?id=<?php echo $id; ?>" method="post" name="" enctype="multipart/form-data" class="form_signup" >
        ...
        <label for="descripcion">Valor mínimo</label>
        <input class="form-control" type="number" placeholder="Valor mínimo" name="minimo" id="minimo" required="true" value= "<?php echo $minimo;?>"></input><br>


        <input type="submit" class= "btn btn-primary" value="Modificar">
        <a href= "admin_reputaciones.php" class="btn btn-primary">Cancelar</a>
