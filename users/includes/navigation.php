...
$lang = array_merge($lang,array(
	...
	"SIGNUP_BUTTONTEXT"		=> "Registrarme",
	"SIGNUP_AUDITTEXT"		=> "Registrado",
	));

// Signin
$lang = array_merge($lang,array(
	"SIGNIN_FAIL"			=> "** INICIO DE SESIÓN FALLIDA **",
	"SIGNIN_TITLE"			=> "Inicio de sesión",
	"SIGNIN_TEXT"			=> "Iniciar Sesión",
	"SIGNOUT_TEXT"			=> "Cerrar sesión",
	"SIGNIN_BUTTONTEXT"		=> "Entrar",
	"SIGNIN_AUDITTEXT"		=> "Sesión iniciada",
	"SIGNOUT_AUDITTEXT"		=> "Sesión finalizada",
	));

//Navigation
$lang = array_merge($lang,array(
	"NAVTOP_HELPTEXT"		=> "Ayuda",
	));
...
<div class="navbar navbar-fixed-top navbar-inverse" role="navigation">
	<div class="container">
		...
		<div class="navbar-header">
			...
			<a class="" href="<?=$us_url_root?>"><img class="img-responsive" src="http://i.imgur.com/tO8W5IC.png" alt="" style="height: 50px; padding-top: 10px" /></a>
		...
		<div class="collapse navbar-collapse navbar-top-menu-collapse navbar-right">
			...
			<ul class="nav navbar-nav ">
		     	...
		     	<?php if($user->isLoggedIn()){ //anyone is logged in?>
					...
					<?php } ?>
					<li class="hidden-sm hidden-md hidden-lg"><a href="<?=$us_url_root?>"><i class="fa fa-fw fa-home"></i> Inicio</a></li> <!-- Hamburger menu link -->
					<?php if (checkMenu(2,$user->data()->id)){  //Links for permission level 2 (default admin) ?>
						<li class="hidden-sm hidden-md hidden-lg"><a href="<?=$us_url_root?>users/admin.php"><i class="fa fa-fw fa-cogs"></i> Panel de Admin</a></li> <!-- Hamburger menu link -->
					...
					<li class="dropdown hidden-xs"><a class="dropdown-toggle" href="#" data-toggle="dropdown"><i class="fa fa-fw fa-cog"></i><b class="caret"></b></a> <!-- regular user menu -->
						<ul class="dropdown-menu"> <!-- open tag for User dropdown menu -->
							<li><a href="<?=$us_url_root?>"><i class="fa fa-fw fa-home"></i> Inicio</a></li> <!-- regular user menu link -->
							<li><a href="<?=$us_url_root?>users/account.php"><i class="fa fa-fw fa-user"></i> Cuenta</a></li>
						<?php if($settings->messaging == 1){ ?>
							<li><a href="<?=$us_url_root?>users/messages.php"><i class="fa fa-fw fa-envelope"></i><?=$msgC?> Mensajes</a></li>
						<?php } ?>
...
<!-- 								<li><a href="<?=$us_url_root?>users/admin.php"><i class="fa fa-fw fa-cogs"></i> Panel de Admin</a></li>  -->
									<li><a href="<?=$us_url_root?>users/administrador.php"><i class="fa fa-fw fa-cogs"></i> Panel de Admin</a></li>
					...
					<li class="hidden-sm hidden-md hidden-lg"><a href="<?=$us_url_root?>users/logout.php"><i class="fa fa-fw fa-sign-out"></i> Cerrar Sesión</a></li> <!-- regular Hamburger logout menu link -->

				<?php }else{ // no one is logged in so display default items ?>
					<li><a href="<?=$us_url_root?>users/login.php" class=""><i class="fa fa-sign-in"></i> Ingresar</a></li>
					<li><a href="<?=$us_url_root?>users/join.php" class=""><i class="fa fa-plus-square"></i> Registrarse</a></li>
					<!-- <li class="dropdown"><a class="dropdown-toggle" href="#" data-toggle="dropdown"><i class="fa fa-life-ring"></i> Ayuda <b class="caret"></b></a>
					<ul class="dropdown-menu">
					<li><a href="<?=$us_url_root?>users/forgot_password.php"><i class="fa fa-wrench"></i> Olvidaste tu contraseña?</a></li> -->
					<?php if ($email_act){ //Only display following menu item if activation is enabled ?>
					<li><a href="<?=$us_url_root?>users/verify_resend.php"><i class="fa fa-exclamation-triangle"></i> Reenviar mail de activación</a></li>
					<?php }?>
					</ul>
					</li>
